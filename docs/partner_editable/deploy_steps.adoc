...
. Sign in to your AWS account, and choose the following link to launch the AWS CloudFormation template. For help understanding the details of the deployment, see link:#_deployment_options[Deployment options] earlier in this guide.
+
[cols="1,1"]
|===
