...
:quickstart-project-name: cloudformation-aws-marketplace-saas
:partner-product-name: AWS Marketplace Serverless SaaS Integration
...
:quickstart-contributors: AWS Marketplace SaaS Integration team
